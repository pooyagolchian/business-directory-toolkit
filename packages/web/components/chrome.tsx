    ...
    <header className="border-b border-[var(--rule)]">
      <div className="mx-auto flex max-w-5xl items-baseline gap-8 px-6 py-5">
        {/*
          ...
          that happened to be serif. Size is the whole separation here — there
          is no colour, no mark, and no weight axis on Instrument Serif — so it
          takes a full step above the section headings to register as the one
          fixed thing on every page.
